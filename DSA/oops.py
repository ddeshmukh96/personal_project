...
# print(s1.name)                # calling via obj        o/p: Karan
# print(Students.name)          # calling via Class name o/p: Anonyomus
...
""" output : Karan  (if class attribute and object attribute has
    for line 127    same variable name remember Objects attribute's
...
c_s2=C_student("Pawan","Chh. Sambhaji Nagar")
...
# print(round(s1_s1.sub_average(),2))
# print(round(s1_s2.sub_average(),2),round(s1_s3.sub_average(),2))
...
# print(car1.name,"is a",car1.type,"Vehicle")
